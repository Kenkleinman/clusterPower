...
where i indicates a cluster, j indicates a subject within the cluster, and xij=1 if subject ij is in the treatment group and 0 if not.  The error term eij is assumed to be distributed normal with mean = 0 and variance 2, while bi, uncorrelated with eij, is assumed to be normal with mean 0 and variance b2.  
